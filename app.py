...
At each position (x, y) on the ground, the height z tells you how high you are.  
...
""")
    ...
    fig.add_trace(go.Scatter3d(x=[px], y=[py], z=[z], mode="markers", marker=dict(size=5, color='gold'), name="Example Point"))

    fig.add_trace(go.Scatter3d(x=[px - s, px + s], y=[py, py], z=[z - fx_val*s, z + fx_val*s],
                               mode="lines", line=dict(color="red", width=6), name="∂f/∂x"))
    fig.add_trace(go.Scatter3d(x=[px, px], y=[py - s, py + s], z=[z - fy_val*s, z + fy_val*s],
...
""")
    ...
    fig.add_trace(go.Scatter3d(x=[px, px + dx], y=[py, py + dy], z=[z, z],
                               ...
                               marker=dict(size=4), name="Gradient (Steepest Ascent)"))
...
# ==========================
    ...
    with left:
        ...
        fig.add_trace(go.Scatter3d(x=[x_val], y=[y_val], z=[z_val], mode="markers",
                                   marker=dict(size=5, color='gold'), name="Selected Point"))
        ...
        fig.add_trace(go.Scatter3d(x=[x_val, x_val + dx], y=[y_val, y_val + dy], z=[z_val, z_val],
                                   mode="lines+markers", line=dict(color="black", width=8),
                                   marker=dict(size=4), name="Gradient"))
